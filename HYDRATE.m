function HYD=HYDRATE(fit,T,P,xV,xL,nc,structure,langmuirC)
...
%akihara(1)=0.6805e-10; akihara(2)=0.3526e-10; epskihara(1)=kB*167.95; epskihara(2)=kB*128.77;
%sigmakihara(1)=2.9663e-10; sigmakihara(2)=3.1713e-10;
akihara(1)=0.6805e-10; akihara(2)=0.3526e-10; epskihara(1)=kB*fit(1); epskihara(2)=kB*fit(2);
sigmakihara(1)=fit(3)*1e-10; sigmakihara(2)=fit(4)*1e-10;
if structure==1  
